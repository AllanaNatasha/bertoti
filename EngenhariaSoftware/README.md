...
Comentário:
O texto traz brevemente a elucidação do que seria a engenharia de software comparando com as demais engenharia que temos contato no dia a dia, trazendo o contra ponto de não termos algo palpável quando tratamos de software, o que dificulta a existência de métodos mais rigorosos dentro da programação.
